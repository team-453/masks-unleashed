...
namespace MasksUnleashed.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRecyclerRepository, RecyclerRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Masks Unleashed API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Masks Unleashed API");
            });
            app.UseRouting();
